...
public class HorrorSpawner {
    ...
    public static void trySpawnHorror(ServerWorld world) {
        ...
        //сущность появляеться только ночью
        long time = world.getTimeOfDay() % 24000;
        if (time < 13000 || time > 23000) {
            return;
        }
        //вероятность спавна еблана
                ...
                if (biome == BiomeKeys.PLAINS ||
                    ...
                    if (ground.isSolid() && world.isAir(spawnPos)) {
                        ...
                        if (horror != null) {
                            ...
                            //защита от спавна
                            //После успешного спавна ждет 100 тиков (~5 секунд)
                            //За это время новый монстр не появится
                            spawnCooldown = 100;
                            return;
                        }
                    }
